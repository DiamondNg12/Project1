    ...
    <ul class="navbar-nav iq-main-menu" id="sidebar">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ activeRoute(route('auth.recoverpw')) }}"
                        href="{{ route('auth.recoverpw') }}">
                        <i class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                fill="currentColor">
                                <g>
        ...
        <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
                <li class="nav-item">
                    <a class="nav-link {{ activeRoute(route('users.show', 1)) }}"
...
@elseif (auth()->user()->role == 'demo_admin')
    <ul class="navbar-nav iq-main-menu" id="sidebar">
        <li class="nav-item static-item">
            <a class="nav-link static-item disabled" href="#" tabindex="-1">
                <span class="default-icon">Home</span>
        ...
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('dashboard')) }}" aria-current="page"
                ...
                <span class="item-name">Trang chủ</span>
            </a>
        </li>
        <li>
            <hr class="hr-horizontal">
...
@elseif (auth()->user()->role == 'user')
    <ul class="navbar-nav iq-main-menu" id="sidebar">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar">
                <li class="nav-item">
                    <a class="nav-link {{ activeRoute(route('auth.signin')) }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ activeRoute(route('auth.signup')) }}"
        ...
        <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ activeRoute(route('users.create')) }}"
        ...
        <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ activeRoute(route('forms.wizard')) }}"
                        href="{{ route('forms.wizard') }}">
                        <i class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                fill="currentColor">
                                <g>
        ...
        <li class="nav-item mb-5">
            ...
            <ul class="sub-nav collapse" id="sidebar-icons" data-bs-parent="#sidebar">
                <li class="nav-item">
                    <a class="nav-link {{ activeRoute(route('icons.solid')) }}"
                        href="{{ route('icons.solid') }}">
                        <i class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                fill="currentColor">
                                <g>
